...
var phoneResult = parser.getResult().device.type;
...
//   // $(".video-wrapper").hide();
//   // $(".video-wrapper video source").attr("src","images/works/work-1/00.mp4");
//   // $(".video-wrapper").html("");
//   $(".hero-image").show();
//   $("#magic-cursor").hide();
// }
// if(phoneResult != "iPhone"){
//   $(".video-wrapper").show();
//   $(".hero-image").css("opacity","0");
//   // $(".video-wrapper video source").attr("src","images/works/work-1/02.mp4");
  
//   if($(".video-wrapper video")){
//     $(".video-wrapper video")[0].load()
//   }
// }
